...
/*The code below reads user input, checks if the command is in the PATH or the current working directory, and executes the command. If the command is not found, an error message is printed.*/
/**
 * path_execute - executes command in PATH
 *
 * @command: full PATH to command
 *
 * @vars: pointer to struct of vars
 *
...
/**
 * find_path - function finds path variable
 *
 * @env: array of env vars
 *
 * Return: pointer to node that contains the path; failure- NULL
 */
 ...
 * @vars: variables
 *
 * Return: void after successful exexcution
 */
...
/**
* execute_cwd - PROG executes the command in current working directory
 *
 * @vars: pointer to struct of vars
 *
...
/**
 * check_for_dir - PROG checks if command is a part of a path
 *
 * @str: command
 *
